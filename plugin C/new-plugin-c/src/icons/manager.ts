...
import type { AdmonitionIconDefinition, IconType } from "../@types";
...
export class IconManager {
    ...
    localIconPath(pack: DownloadableIconPack) {
        return `${this.plugin.app.plugins.getPluginFolder()}/${this.plugin.app.plugins.getPluginFolder ? "obsidian-admonition" : ""}/${pack}.json`;
    }
